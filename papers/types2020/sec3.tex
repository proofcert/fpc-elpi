...
It may be at first surprising that there are no introduction rules for
...
\todo{Lookup Coq rules for unfold rule}
...
% LocalWords:  Elpi modularity Herbelin bc PTSC's dprolog
