...
the testing phase of the \lsti{dep_pbt} tactic. Differently from Fig.~\ref{fig:augmented} we appeal, via quotations, to Coq's defined connectives. An \lsti{atomic} proposition is one defined \lsti{Inductive}ly. The predicate \lsti{definition} hides the API call to the constructors of such a type.
...
% formulas.
 \lstinputlisting[linerange={interp-end}]{code/dep-kernel.sig}
\lstinputlisting[linerange={interp-end}]{code/dep-kernel-v2.mod}
