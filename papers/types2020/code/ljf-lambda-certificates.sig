...
type storeC                     cert -> (A -> cert) -> (A -> index) -> prop.
type decideE                    cert -> cert -> index -> prop.
type decideR_je, storeR_jc,
     releaseL_je, releaseR_je      cert -> cert -> prop.
type initialE                   cert -> prop.
...
type impC                        cert -> cert -> prop.
type andPos_jc                     cert -> cert -> prop.
type or_jc, andNeg_jc,
     impE, andPos_je             cert ->  cert -> cert -> prop.
