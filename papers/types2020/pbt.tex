...
proof-theoretical reconstruction of property-based testing (PBT) \cite{fink97sen}of
...
While nothing prevents us from porting all the PBT features we have
accounted for in~\cite{blanco19ppdp}, for the sake of this paper we
will implement only FPC corresponding to different flavors
...
code in the \lsti{unfoldE} expert to implement a form of random data
...
In our Coq  setting $A_i$ and $B$ will be \lsti{Inductive}
...
at most $5$  form the library \lsti{Inductive} definitions of
