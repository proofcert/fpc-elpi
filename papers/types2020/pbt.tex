...
\begin{metanote}
  ...
  \item the simple ordered example
  \item a bit of details about the \texttt{aexp} example
  \end{itemize}
\end{metanote}

Let us consider a  relational specification of orered list, as well as insertion in such lists:
\begin{lstlisting}
...
\end{lstlisting}
%
A property we may wish to checl before embaring in a formal proof is whether insertion preserves ordered-ness. Since we did slip in an error, our tactic reports a counter-example:
\begin{lstlisting}
