...
Elpi Tactic dd_fpc.
From fpc_elpi.fpc Extra Dependency "ljf-dep.elpi" as ljf_dep.
From fpc_elpi.fpc Extra Dependency "dd-fpc.mod" as dd_fpc.
Elpi Accumulate File dd_fpc.
Elpi Accumulate File ljf_dep.
Elpi Accumulate lp:{{
  solve (goal _Ctx _RawEv Ty _Ev [int N] as G) Out :-
    int_to_nat N Nat,
    ljf_entry (dd Nat) Ty Ev1,
    refine Ev1 G Out.
    % coq.say "Proof:" {coq.term->string Ev1}.
...
Elpi Tactic deb_fpc.
From fpc_elpi.fpc Extra Dependency "deb-fpc.elpi" as deb_fpc.
Elpi Accumulate File ljf_dep.
